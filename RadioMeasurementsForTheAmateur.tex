...
\item Note the amplitude of the meter. This amplitude is proportional to the internal resistance in your crystal. Calculate the dB loss, this should be a negative value.: $ dB = crystal loss (dB) - reference level (dB) $ \vspace{30pt}
\item Calculate the internal resistance of the crystal: $ R_{s} = 100\cdot((10^{\frac{dB}{20}})^{-1}-1) $ \vspace{30pt}
