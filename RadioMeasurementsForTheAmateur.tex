...
Noise figure measurement have the advantage of it being independent on the bandwidth of the receiver. The MDS can then be calculated from the bandwidth of the receiver.
\subsection*{Equipment List}
\begin{itemize}
